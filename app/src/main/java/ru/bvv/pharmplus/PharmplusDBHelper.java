...
//    private static final String DB_NAME = "pharm";
//    private static final int DB_VERSION = 2;
//
//    public PharmplusDBHelper (Context context){
//        super(context, DB_NAME, null, DB_VERSION);
...
//                                        int resourceID){
//        ContentValues medicinesValues = new ContentValues();
//        medicinesValues.put("NAME", name);
//        medicinesValues.put("CHARACTERISTIC", characteristic);
//        medicinesValues.put("COMPOSITION", composition);
//        medicinesValues.put("PHARMACOLOGY_EFFECT", pharmacology);
//        medicinesValues.put("INDICATIONS_FOR_USE", indications);
//        medicinesValues.put("CONTRAINDICATIONS", contraindications);
//        medicinesValues.put("SIDE_EFFECTS", sideEffects);
//        medicinesValues.put("MODE_OF_APPLICATION", modeOfApplication);
//        medicinesValues.put("RELEASE_FORM", releaseForm);
//        medicinesValues.put("SHELF_LIFE", shelfLife);
//        medicinesValues.put("COST", cost);
//        medicinesValues.put("CATEGORY", category);
//        medicinesValues.put("IMAGE_RESOURCE_ID", resourceID);
//        db.insert("MEDICINES", null, medicinesValues);
//    }
//
//    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion){
